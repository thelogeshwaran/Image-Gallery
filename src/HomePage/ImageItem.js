    ...
    return (
        <div  >
                ...
                <div  className="options" >
                    ...
                    {
                        like ? <Fab  style={{height:"40px",width:"40px"}} aria-label="like"><FavoriteIcon onClick={()=>handleLike(doc)}/> </Fab> : <Fab style={{height:"40px",width:"40px"}} disabled aria-label="like"><FavoriteIcon /> </Fab>
                    }
                    ...
                    <div style={{ marginTop:"10px"}} onClick={()=>addToPersonal(doc) }>
                        { bookmark ? <BookmarkIcon style={{ height:"40px" , width: "40px"}} /> : <BookmarkBorderIcon style={{ height:"40px" , width: "40px"}} />}
